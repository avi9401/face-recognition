...
constructor(props) {
  ...
  onSubmitSignIn = () =>{
    fetch('https://secure-crag-86553.herokuapp.com/register', {
      method: 'post',
           ...
           <main className="pa4 black-80">
             <div className="measure">
               <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                 <legend className="f2 fw6 ph0 mh0 mb2">Register</legend>
                  <div className="mt3">
               ...
               <div className="">
                 ...
                 className="b hover-bg-green ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib" type="submit" value="Register" />
               </div>
             </div>
           </main>
        </article> 
